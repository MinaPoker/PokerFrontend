...
import CreateAvatarPopUp from "@/components/create-avatar";
...
const Home = () => {
  ...
  return (
    <div className='bg-white w-[1280px] h-[720px] overflow-hidden mx-auto my-8 px-4 py-2 rounded-lg bg-cover bg-[url("/bg-2.jpg")] relative shadow-[0_0_20px_rgba(0,0,0,0.8)]'>
      ...
      <div
        className='absolute left-8 -right-8 top-14 -bottom-14 bg-no-repeat bg-[url("/dealer.png")] transform-gpu'
        ref={dealerRef}
      >
      ...
      <div className="absolute top-0 left-1/2 right-0 bottom-0 pr-20 py-12">
        ...
        <div className="relative text-center flex justify-center">
          ...
          <StyledButton
            ...
            className="absolute bg-[#ff9000] bottom-4 text-2xl left-1/2 -translate-x-1/2"
          ...
          <div>
            ...
            <div>
              {!profile && (
                <div>
                  <Link href="/create">
                    <StyledButton className="bg-[#00b69a] bottom-4 text-2xl  m-8 ml-[105px] left-3/5 -translate-x-1/2">
                      Create Profile{" "}
                    </StyledButton>
                  </Link>
                  <CreateProfilePopUp onClose={handlePopupClose} setAvatarPopup={setAvatarPopup} />
                </div>
              )}
              {avatarPopup && (
                <div>
                  <CreateAvatarPopUp onClose={handleAvatarPopup} />
                </div>
              )}
