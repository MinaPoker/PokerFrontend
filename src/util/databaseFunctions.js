...
const supabase = createClient(
  "https://eglkxepsbbjqqofsrrzb.supabase.co",
...
export const addReward = async (address, reward) => {
  try {
    const { data, error } = await supabase
      .from("user_data")
    ...
    console.log("Supabase reward added", data);
    return data;
  } catch (error) {
    console.error("Supabase error:", error);
  }
...
export const getReward = async (address) => {
  try {
    ...
    console.log("Supabase reward retrieved", data);
    return data;
  } catch (error) {
    console.error("Supabase error:", error);
  }
...
export const getUserData = async (address) => {
  try {
    ...
    console.log("Supabase user data retrieved", data);
    return data;
  } catch (error) {
    console.error("Supabase error:", error);
  }
